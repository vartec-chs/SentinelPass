...
import { EXTENSION_FILE, EXTENSION_NAME, INVOKE_COMMANDS, PATHS } from '@configs'

import { CreatePasswordStorageSchema, createPasswordStorageSchema } from './form.schema'
...
export const CreatePasswordStorageForm: FC = () => {
	...
	const createStorage = useInvoke<any, { dto: PasswordStorageCreate }>({
		command: INVOKE_COMMANDS.passwordStorage.create,
		onError: (error) => {
			console.log(error)
